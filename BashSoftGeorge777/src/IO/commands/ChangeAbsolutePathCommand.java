...
public class ChangeAbsolutePathCommand extends Command {
    ...
    public ChangeAbsolutePathCommand(String line, String[] data, IOManager ioManager, Tester tester, DownloadManager downloadManager, StudentsRepository studentsRepository) {
