...
public class DownloadAsynchCommand extends Command {
    ...
    public DownloadAsynchCommand(String line, String[] data, IOManager ioManager, Tester tester, DownloadManager downloadManager, StudentsRepository studentsRepository) {
