...
public class MakeDirectoryCommand extends Command {
    ...
    public MakeDirectoryCommand(String line, String[] data, IOManager ioManager, Tester tester, DownloadManager downloadManager, StudentsRepository studentsRepository) {
