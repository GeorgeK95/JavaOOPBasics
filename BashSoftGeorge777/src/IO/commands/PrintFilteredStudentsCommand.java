...
public class PrintFilteredStudentsCommand extends Command {
    ...
    public PrintFilteredStudentsCommand(String line, String[] data, IOManager ioManager, Tester tester, DownloadManager downloadManager, StudentsRepository studentsRepository) {
