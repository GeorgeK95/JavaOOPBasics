...
public class DownloadFileCommand extends Command {
    ...
    public DownloadFileCommand(String line, String[] data, IOManager ioManager, Tester tester, DownloadManager downloadManager, StudentsRepository studentsRepository) {
