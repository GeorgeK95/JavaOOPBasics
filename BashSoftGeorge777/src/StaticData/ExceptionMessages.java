...
public class ExceptionMessages {
    public static final String DATA_ALREADY_INITIALIZED = "Data was already initialized.";
    public static final String DATA_NOT_INITIALIZED = "Data was already initialized.";
    ...
    public static final String NOT_ENROLLED_IN_COURSE = "Invalid course.";
    ...
    public static final String INVALID_DESTINATION = "The source does not exist.";
}
